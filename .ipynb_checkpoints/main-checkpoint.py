...
numpy_array = np.array([years, mean_sale_stats, std_sale_stats, prob_sale_states])

df = pd.DataFrame(numpy_array, columns=['Year', 'Mean Sales', 'Standard Deviation of Sales', 'Probability of Sale Being Between $200K and $300K'])
